...
```
**_Please fill in the compareInfo.csv before executing the above command_**
...
```
The execution of the above command will produce 6 data files which are required for the [OmicsView](https://github.com/interactivereport/OmicsView){target="_blank"} project import.

**_Please fill in the empty entries in the Project_Info.csv before import._**
