...
In [sys.yml](https://github.com/interactivereport/RNASequest/blob/main/src/sys.yml){target="_blank"} file is used to set the default configurations of the whole pipeline, including paths for Quickomics visualization. Please modify this file before running the pipeline, since the paths will be different from server to server.
