...
QuickOmics has a feature to load a project directly from URL in the form of [https://quickomics.bxgenomics.com/?serverfile=SRP199678](https://quickomics.bxgenomics.com/?serverfile=SRP199678){target="_blank"}, which requires saving project data files to a user-specified directory on the server hosting QuickOmics. To use this feature, create a file called config.csv in the QuickOmics App folder.
