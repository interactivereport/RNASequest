...
For users that have their own dataset to run EA, several files can be prepared from scratch. Here are the detailed instruction of what files are required to run the pipeline.
...
- **project.yml**
  ...
  The project.yml file contains a high-level summary of 
