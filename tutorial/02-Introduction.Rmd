...
ExpressionAnalysis (EA) is a Converter from a set of RNAseq analysis output to QuickOmics ([http://quickomics.bxgenomics.com](http://quickomics.bxgenomics.com){target="_blank"}) for interactive visualization.
